<button {{
    $attributes->merge([
        'class' => 'inline-flex items-center px-4 py-2 bg-green-700 dark:bg-green-200 border border-transparent rounded-md font-semibold text-xs text-gray-200 dark:text-gray-800
