...
backend - Controller + Requests + Models in Modules

frontend - Breeze + Blade Templates + Tailwind CSS + Tooplate Template (Antique Cafe with JQuery, Parallax, singlePageNav, Tailwind CSS) + JS Vanilla
